...
function add_payment_gateway_extra_charges_row(){
	...
	echo '<input type="hidden" name="extrachargevalue" value="'.$this -> current_gateway_extra_charges.'" />';
	echo '<input type="hidden" name="extrachargetitle" value="'.$this->current_gateway_title.' Extra Charges" />';
     }?></td>
 </tr>
 <?php
}
